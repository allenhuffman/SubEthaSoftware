/*
 * MultiBoot.c V1.01 by Allen C. Huffman
...
#define MAXDIRS 50 /* maximum number of directory entries to read */
...
/* rest of code goes here... */
   ...
   fputs("\nMultiBoot V1.01 by Allen Huffman (OS-9) and Terry Todd (RS-DOS).\n",stderr);
