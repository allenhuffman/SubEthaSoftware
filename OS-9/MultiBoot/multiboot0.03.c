/*
 * MultiBoot.c V0.03 by Allen C. Huffman
 ...
 * 0.03 7/12/93 - Changes for up to 16 bootfiles (OS9BOOT V1.1)
...
char mb_sec33_15[] = { /* Terry's RS-DOS MultiBoot code... 1024 Bytes */
   ...
   0,0,0,0,0,0,66,66,16,32,49,46,32,79,114,105,103,105,110,97,108,32,79,83,
...
/* rest of code goes here... */
   ...
   fputs("\nMultiBoot V0.03 by Allen Huffman (OS-9) and Terry Todd (RS-DOS).\n",stderr);
...
/* here directory entries have been read...ask user stuff */
   ...
   fputs("Enter menu delay value (in seconds) [ENTER=10] : ",stdout);
...
{
   fputs("\nMultiBoot V0.03 by Allen Huffman of Sub-Etha Software\n",stderr);
...
int fpath,sides;
{
   ...
   WriteBuffer(fpath,mb_sec33_15,1024);
