 ...
 * 1.04 6/07/95 - malloc space for directory names and stuff (FAST dir!), fix
...
char *argv[];      /* argv[1-?] = argurments */
{
   ...
   TopText(wpath,"Don't","Towel V1.04 - By Allen Huffman","Panic!");
   About(wpath);
...
Usage()
{
   fputs("\nTowel V1.04 by Allen Huffman (coco-sysop@genie.geis.com)\n",stderr);
